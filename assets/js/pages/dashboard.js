...
options1 = (new ApexCharts(document.querySelector("#chart01"), options1).render(), {
    chart: {
        type: "area",
        height: 50,
        sparkline: {
...
options1 = (new ApexCharts(document.querySelector("#chart02"), options1).render(), {
    chart: {
        type: "area",
        height: 50,
        sparkline: {
...
options1 = (new ApexCharts(document.querySelector("#chart03"), options1).render(), {
    chart: {
        type: "area",
        height: 50,
        sparkline: {
...
options = (new ApexCharts(document.querySelector("#chart04"), options1).render(), {
    chart: {
        height: 180,
        type: "donut"
    },
