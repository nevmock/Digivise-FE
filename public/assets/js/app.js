class Components {
    initBootstrapComponents() {
        [...document.querySelectorAll('[data-bs-toggle="popover"]')].map(e => new bootstrap.Popover(e)), [...document.querySelectorAll('[data-bs-toggle="tooltip"]')].map(e => new bootstrap.Tooltip(e)), [...document.querySelectorAll(".offcanvas")].map(e => new bootstrap.Offcanvas(e));
        ...
        var t = document.getElementById("liveAlertBtn");
        ...
        e && e.forEach(function(i) {
            ! function e() {
                var t = +i.getAttribute("data-target"),
                    n = +i.innerText,
                    o = t / 250;
                o < 1 && (o = 1), n < t ? (i.innerText = (n + o).toFixed(0), setTimeout(e, 1)) : i.innerText = a(t), a(i.innerText)
            }()
        })
    }
    init() {
        this.initBootstrapComponents(), this.initfullScreenListener(), this.initCounter()
    }
}
...
class ThemeLayout {
        ...
        document.querySelectorAll(".navbar-nav li [data-bs-toggle='collapse']").forEach(e => {
            ...
            e.addEventListener("show.bs.collapse", function(t) {
                ...
                document.querySelectorAll(".navbar-nav .collapse.show").forEach(e => {
                    e !== t.target && e !== n && new bootstrap.Collapse(e).hide()
                })
            })
            ...
            var e, o, i, a, c, l, t = document.querySelector(".nav-item li a.active");

            function r() {
                e = l += 20, t = a, n = c;
                var e, t, n = (e /= i / 2) < 1 ? n / 2 * e * e + t : -n / 2 * (--e * (e - 2) - 1) + t;
                o.scrollTop = n, l < i && setTimeout(r, 20)
            }
            null != t && (e = document.querySelector(".app-sidebar .simplebar-content-wrapper"), t = t.offsetTop - 300, e) && 100 < t && (i = 600, a = (o = e).scrollTop, c = t - a, l = 0, r())
        }, 200))
    }
    initConfig() {
    ...
    changeMenuColor(e) {
        this.config.menu.color = e, this.html.setAttribute("data-sidebar-color", e), this.setSwitchFromConfig()
    }
    changeMenuSize(e, t = !0) {
        this.html.setAttribute("data-sidebar-size", e), t && (this.config.menu.size = e, this.setSwitchFromConfig())
    }
    changeThemeMode(e) {
    ...
    resetTheme() {
        this.config = JSON.parse(JSON.stringify(window.defaultConfig)), this.changeMenuColor(this.config.menu.color), this.changeMenuSize(this.config.menu.size), this.changeThemeMode(this.config.theme), this.changeTopbarColor(this.config.topbar.color), this._adjustLayout()
    }
    initSwitchListener() {
        var n = this,
            e = (document.querySelectorAll("input[name=data-sidebar-color]").forEach(function(t) {
                t.addEventListener("change", function(e) {
                    n.changeMenuColor(t.value)
                })
            }), document.querySelectorAll("input[name=data-sidebar-size]").forEach(function(t) {
                t.addEventListener("change", function(e) {
        ...
        e && e.addEventListener("click", function() {
            ...
            "hidden" !== t ? "condensed" === t ? n.changeMenuSize("condensed" == e ? "default" : e, !1) : n.changeMenuSize("condensed", !1) : n.showBackdrop(), n.html.classList.toggle("sidebar-enable")
        })
    }
    showBackdrop() {
        let t = document.createElement("div"),
            n = (t.classList = "offcanvas-backdrop fade show", document.body.appendChild(t), document.body.style.overflow = "hidden", 1040 < window.innerWidth && (document.body.style.paddingRight = "15px"), this);
        t.addEventListener("click", function(e) {
            n.html.classList.remove("sidebar-enable"), document.body.removeChild(t), document.body.style.overflow = null, document.body.style.paddingRight = null
        })
    }
    initWindowSize() {
        var t = this;
    ...
    setSwitchFromConfig() {
        sessionStorage.setItem("__DARKONE_CONFIG__", JSON.stringify(this.config)), document.querySelectorAll(".settings-bar input[type=radio]").forEach(function(e) {
            e.checked = !1
        });
        var e, t, n, o = this.config;
        o && (e = document.querySelector("input[type=radio][name=data-bs-theme][value=" + o.theme + "]"), t = document.querySelector("input[type=radio][name=data-topbar-color][value=" + o.topbar.color + "]"), n = document.querySelector("input[type=radio][name=data-sidebar-size][value=" + o.menu.size + "]"), o = document.querySelector("input[type=radio][name=data-sidebar-color][value=" + o.menu.color + "]"), e && (e.checked = !0), t && (t.checked = !0), n && (n.checked = !0), o) && (o.checked = !0)
    }
    init() {
