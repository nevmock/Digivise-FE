...
import detailAdsJson from "../../api/detail-tiga-ads.json";


export default function DetailTigaAds() {
    ...
    const allColumns = [
        ...
        { key: "mathcing_type", label: "Penempatan halaman rekomendasi" },
        { key: "cost_per_click", label: "Harga bid" },
